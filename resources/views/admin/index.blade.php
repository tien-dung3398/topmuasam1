...
<!-- //bootstrap-css -->
<!-- Custom CSS -->
<link href="{{asset('backend/css/show.css')}}" rel='stylesheet' type='text/css' />
...
<link rel="stylesheet" href="{{asset('backend/css/swiper.min.css')}}" type="text/css"/>
<!-- calendar -->
...
<!--logo start-->
<div class="brand">
    <a target="_blank" href="{{url('/')}}" class="logo"  style="font-size:24px;padding-left:15px">
        Topmuasam
    </a>
