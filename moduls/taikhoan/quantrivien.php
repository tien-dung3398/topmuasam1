...
<div class="quantrivien">
    <div class="title">
        <p><i class="fas fa-users-cog"></i> Quản Trị Viên</p>
        <div class="search">
                ...
                if ($row > 0) { ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="r4"><a href=""><i class="fas fa-tools"></i></a></td>
                            <td class="row4 r4"><a href=""><i class="far fa-trash-alt"></i></a></td>
                        </tr>
                    <?php
                    }
                    ?>
                ...
                ?>
                    <form action="moduls/taikhoan/xuly.php?id=<?= $dong['id_admin']?>" method="post" enctype="multipart/form-data">
                        <tr>
                            ...
                            <td class="r4"><button type="submit" name="sua"><i class="fas fa-tools"></i></button></td>
